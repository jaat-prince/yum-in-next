...
function Dashbr({ title, subtitle, text, tclass }) {
  return (
    <div className="border border-[#e2e8f0] p-4 rounded-lg hover:border-[#f58220] w-full sm:max-w-[400px] transition-all ease-in-out duration-500 flex flex-col justify-between">
